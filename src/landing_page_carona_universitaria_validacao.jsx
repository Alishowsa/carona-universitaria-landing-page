        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              <a href="https://docs.google.com/forms/d/e/1FAIpQLSdVrCn4sX8uMV6TSP5HJ1MeqRAtFMN6-PAx-8y8ctRXDMV3oQ/viewform"
                 target="_blank" rel="noopener noreferrer"
                 className="bg-white hover:bg-gray-100 transition text-purple-700 font-bold px-6 py-4 rounded-2xl shadow-lg">
                Participar da pesquisa
              </a>

              <a href="#beneficios" className="border-2 border-gray-300 hover:border-purple-400 transition px-6 py-4 rounded-2xl font-semibold">
                Ver benefícios
              </a>
            </div>
